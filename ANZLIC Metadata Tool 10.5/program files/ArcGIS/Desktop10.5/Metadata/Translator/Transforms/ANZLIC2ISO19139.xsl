...
<xsl:stylesheet version="1.0" exclude-result-prefixes="esri res t msxsl" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:t="http://www.esri.com/xslt/translator" xmlns:esri="http://www.esri.com/metadata/" xmlns:res="http://www.esri.com/metadata/res/" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
	...
	<xsl:template match="/">
		<gmd:MD_Metadata xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
			<!--MD_Metadata xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"-->
	...
	<xsl:template name="metadata">
		...
		<!--ANZLIC: validate FileIdentifier-->
		<xsl:if test="(not(/metadata/mdFileID) or (/metadata/mdFileID = ''))">
			<xsl:message terminate="yes">Validation Fail: Metadata.Details - File Identifier required</xsl:message>
		</xsl:if>	
		<!--End: ANZLIC: validate FileIdentifier-->
		...
		<!--ANZLIC: validate languae code-->		
		<xsl:if test="(/metadata/mdLang/languageCode/@value = '' or not(/metadata/mdLang/languageCode))">
			<xsl:message terminate="yes"> Validation Fail: Metadata.Details - Language code required</xsl:message>			
		</xsl:if>	
		<!--End: ANZLIC: validate languae code-->
		
		<!--ANZLIC: validate character set-->		
		<xsl:if test="(/metadata/mdChar/CharSetCd/@value = '' or not(/metadata/mdChar/CharSetCd))">
			<xsl:message terminate="yes"> Validation Fail: Metadata.Details - Character set required</xsl:message>			
		</xsl:if>			
		<!--End: ANZLIC: validate character set-->
		...
		<!--ANZLIC: validate Parent Identifier-->
		<!--Check for series type codes and enforce parentid if found-->
		<!--The ScopeCode list and codes is found at the bottom of this document-->		
		<xsl:if test="(/metadata/mdHrLv/ScopeCd/@value = 006 or /metadata/mdHrLv/ScopeCd/@value = 020 or /metadata/mdHrLv/ScopeCd/@value = 021 or /metadata/mdHrLv/ScopeCd/@value = 022 or /metadata/mdHrLv/ScopeCd/@value = 023 or /metadata/mdHrLv/ScopeCd/@value = 024)">
			<xsl:if test="(/metadata/mdParentID ='' or not(/metadata/mdParentID))">
				<xsl:message terminate="yes"> Validation Fail: Metadata.Details - Parent Identifier required</xsl:message>			
			</xsl:if>	
		</xsl:if>			
		<!--End: ANZLIC: validate Parent Identifier-->
		...
		<!--ANZLIC: validate Hierarchy level-->		
		<xsl:if test="not(/metadata/mdHrLv/ScopeCd) or /metadata/mdHrLv/ScopeCd/@value=''">
			<xsl:message terminate="yes">Validation Fail: Metadata.Details - Hierarchy Level required</xsl:message>
		</xsl:if>
		<!--End: ANZLIC: validate Hierarchy level-->
		...
		<xsl:if test="not(/metadata/Esri/ArcGISProfile = 'NAP')">
			...
			<!--ANZLIC: validate Hierarchy Level Name for 005 = dataset-->			
			<xsl:if test="(not(/metadata/mdHrLvName) or /metadata/mdHrLvName ='' )">
				<xsl:message terminate="yes">Validation Fail: Metadata.Details - Hierarchy name is required</xsl:message>
			</xsl:if>			
			<!--End: ANZLIC: validate Hierarchy level name-->
		</xsl:if>
					
		<!--ANZLIC: validate contact-->		
		<xsl:choose>
			<xsl:when test="(count(/metadata/mdContact/rpIndName) + count(/metadata/mdContact/rpOrgName) + count(/metadata/mdContact/rpPosName)) &gt; 0"/>
			<xsl:otherwise>
				<xsl:message terminate="yes">Validation Fail: Metadata.Contacts - Either contact name, organisation or position must be present</xsl:message>
			</xsl:otherwise>						
		</xsl:choose>
		<xsl:choose>
			<xsl:when test="(/metadata/mdContact/rpIndName !='' or (/metadata/mdContact/rpOrgName !='') or (/metadata/mdContact/rpPosName !=''))"/>
			<xsl:otherwise>
				<xsl:message terminate="yes">Validation Fail: Metadata.Contacts - Either contact name, organisation or position must be present</xsl:message>
			</xsl:otherwise>						
		</xsl:choose>		
		<!--End: ANZLIC: validate contact-->
		
		<!-- ANZLIC Validation Responsable Party Role-->
		<xsl:if test="(not(/metadata/mdContact/role/RoleCd) or (metadata/mdContact/role/RoleCd/@value = ''))">
			<xsl:message terminate="yes">Validation Fail: Metadata.Contacts - Role is required'</xsl:message>
		</xsl:if>
		<!--End: ANZLIC Validation Responsable Party Role-->
					...
					<xsl:when test="count (/metadata/mdDateSt[. != '']) &gt; 1">
						<xsl:for-each select="(/metadata/mdDateSt[. != ''])[1]">
							<xsl:call-template name="dateOrDateTimeElements">
								<xsl:with-param name="eleName" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">gmd:dateStamp</xsl:with-param>
							</xsl:call-template>
						</xsl:for-each>
					</xsl:when>
					<xsl:otherwise>
		...
		<!--ANZLIC: validate dateStamp-->		
		<xsl:if test="((/metadata/mdDateSt[. = '']) or not(/metadata/mdDateSt))">
			<xsl:message terminate="yes">Validation Fail: Metadata.Details - Date Stamp is required</xsl:message>
		</xsl:if>
		<!--End: ANZLIC: validate dateStamp-->		
		<xsl:choose>
	...
	<xsl:template name="MD_MaintenanceInformation">
		...
		<xsl:for-each select="(dateNext[. != ''])[1]">
			<xsl:call-template name="dateOrDateTimeElements">
				<xsl:with-param name="eleName" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">gmd:dateOfNextUpdate</xsl:with-param>
			</xsl:call-template>
		</xsl:for-each>
	...
	<xsl:template name="identificationInfo">
		<!--ANZLIC: validate Abstract-->
		<xsl:if test="(not(idAbs) or idAbs ='')">
			<xsl:message terminate="yes">Validation Fail: Overview.Item Description -  Abstract is required</xsl:message>
		</xsl:if>	
		<!--End: ANZLIC: validate Abstract-->
	...
	<xsl:template name="MD_DataIdentification">
		...
		<!--ANZLIC: validate Dataset Languague code-->
		<xsl:if test="(not(dataLang/languageCode) or dataLang/languageCode/@value='')">
			<xsl:message terminate="yes">Validation Fail: Resource.Details - language is required</xsl:message>
		</xsl:if>
		<!--End: ANZLIC: validate Dataset Languague code-->
		
		<!--ANZLIC: validate Dataset Languague character set-->
		<xsl:if test="(not(dataChar/CharSetCd) or dataChar/CharSetCd/@value='')">
			<xsl:message terminate="yes">Validation Fail: Resource.Details - character set is required</xsl:message>
		</xsl:if>
		<!--End: ANZLIC: validate Dataset Languague character set-->
				
		<!--ANZLIC: validate Topic Category-->
		<xsl:if test="(not(tpCat/TopicCatCd) or tpCat/TopicCatCd/@value='')">
			<xsl:message terminate="yes">Validation Fail: Overview.Topics and Keywords - Topic category is required</xsl:message>
		</xsl:if>	
		<!--End: ANZLIC: validate Topic Category-->
	...
	<xsl:template name="SV_ServiceIdentification">
		...
		<!--ANZLIC: validate Topic Category-->
		<!--if Hierarchy level is series Topic category is mandatory-->
		<xsl:if test="(/metadata/mdHrLv/ScopeCd/@value = 006)">
			<xsl:if test="(not(tpCat/TopicCatCd) or tpCat/TopicCatCd/@value='')">
				<xsl:message terminate="yes">Validation Fail: Topic category required</xsl:message>
			</xsl:if>	
		</xsl:if>	
		<!--End: ANZLIC: validate Topic Category-->		
		...
		<xsl:for-each select="svTypeVer[. != '']">
			<srv:serviceTypeVersion xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
				<gco:CharacterString>
					<xsl:value-of select="."/>
				</gco:CharacterString>
		...
		<xsl:for-each select="dataExt[(count(*) - count(geoEle/GeoBndBox/@esriExtentType[. = 'native'])) &gt; 0]">
			<srv:extent xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
				<gmd:EX_Extent>
					<xsl:call-template name="EX_Extent"/>
				</gmd:EX_Extent>
			</srv:extent>
		...
		<xsl:for-each select="svCouplRes[(.//* != '') or (.//@*[not(name() = 'Sync')] != '')]">
			<srv:coupledResource xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
		...
		<xsl:choose>
				...
				<xsl:choose>
					...
					<xsl:when test="count (svCouplType/CouplTypCd/@value[. != '']) &gt; 1">
						<xsl:for-each select="(svCouplType/CouplTypCd/@value[. != ''])[1]">
							...
							<xsl:variable name="codespace">ISOTC211/19115</xsl:variable>
							<xsl:if test="($code != '')">
								<srv:couplingType xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
			...
			<xsl:otherwise>
				<srv:couplingType gco:nilReason="missing" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"/>
			</xsl:otherwise>
		</xsl:choose>
		<xsl:choose>
				...
				<xsl:choose>
					...
					<xsl:otherwise>
						<xsl:for-each select="svOper[(.//* != '') or (.//@*[not(name() = 'Sync')] != '')]">
							<srv:containsOperations xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
			...
			<xsl:otherwise>
				<srv:containsOperations gco:nilReason="missing" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"/>
			</xsl:otherwise>
		</xsl:choose>
	...
	<xsl:template name="SV_OperationMetadata">
		<xsl:choose>
			<xsl:when test="(count(svOpName[. != '']) &gt; 0)">
				<xsl:choose>
					...
					<xsl:when test="count (svOpName[. != '']) &gt; 1">
						<xsl:for-each select="(svOpName[. != ''])[1]">
							<srv:operationName xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
								<gco:CharacterString>
									<xsl:value-of select="."/>
								</gco:CharacterString>
							</srv:operationName>
			...
			<xsl:otherwise>
				<srv:operationName gco:nilReason="missing" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"/>
			</xsl:otherwise>
		</xsl:choose>
		<xsl:choose>
				...
				<xsl:choose>
					...
					<xsl:otherwise>
						<xsl:for-each select="svDCP/DCPListCd/@value[. != '']">
							...
							<xsl:variable name="codespace">ISOTC211/19115</xsl:variable>
							<xsl:if test="($code != '')">
								<srv:DCP xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
			...
			<xsl:otherwise>
				<srv:DCPList gco:nilReason="missing" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"/>
			</xsl:otherwise>
		</xsl:choose>
		<xsl:for-each select="(svDesc[. != ''])[1]">
			<srv:operationDescription xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
				<gco:CharacterString>
					<xsl:value-of select="."/>
				</gco:CharacterString>
		...
		<xsl:for-each select="(svInvocName[. != ''])[1]">
			<srv:invocationName xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
				<gco:CharacterString>
					<xsl:value-of select="."/>
				</gco:CharacterString>
			</srv:invocationName>
		...
		<xsl:for-each select="svParams[(.//* != '') or (.//@*[not(name() = 'Sync')] != '')]">
			<srv:parameters xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
				<srv:SV_Parameter>
		...
		<xsl:choose>
				...
				<xsl:choose>
					...
					<xsl:otherwise>
						<xsl:for-each select="svConPt[(.//* != '') or (.//@*[not(name() = 'Sync')] != '')]">
							<srv:connectPoint xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
								<gmd:CI_OnlineResource>
									<xsl:call-template name="CI_OnlineResource"/>
								</gmd:CI_OnlineResource>
							</srv:connectPoint>
			...
			<xsl:otherwise>
				<srv:connectPoint gco:nilReason="missing" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"/>
			</xsl:otherwise>
		</xsl:choose>
		<xsl:for-each select="svOper[(.//* != '') or (.//@*[not(name() = 'Sync')] != '')]">
			<srv:dependsOn xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
				<srv:SV_OperationMetadata>
					<xsl:call-template name="SV_OperationMetadata"/>
				</srv:SV_OperationMetadata>
			</srv:dependsOn>
	...
	<xsl:template name="SV_Parameter">
		<xsl:choose>
				...
				<xsl:choose>
					...
					<xsl:when test="count (svParName[(aName != '') or (attributeType/aName != '')]) &gt; 1">
						<xsl:for-each select="(svParName[(aName != '') or (attributeType/aName != '')])[1]">
							<srv:name xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
								<gco:MemberName>
			...
			<xsl:otherwise>
				<srv:name gco:nilReason="missing" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"/>
			</xsl:otherwise>
		</xsl:choose>
		<xsl:for-each select="(svParDir/ParamDirCd/@value[. != ''])[1]">
			<srv:direction xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
				<xsl:variable name="code">
		...
		<xsl:for-each select="(svDesc[. != ''])[1]">
			<srv:description xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
				<gco:CharacterString>
					<xsl:value-of select="."/>
				</gco:CharacterString>
			</srv:description>
		...
		<xsl:choose>
				...
				<xsl:choose>
					...
					<xsl:when test="count (svParOpt[. != '']) &gt; 1">
						<xsl:for-each select="(svParOpt[. != ''])[1]">
							<srv:optionality xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
								<gco:CharacterString>
									<xsl:value-of select="."/>
								</gco:CharacterString>
							</srv:optionality>
			...
			<xsl:otherwise>
				<srv:optionality gco:nilReason="missing" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"/>
			</xsl:otherwise>
		</xsl:choose>
		<xsl:choose>
				...
				<xsl:choose>
					...
					<xsl:when test="count (svRepeat[. != '']) &gt; 1">
						<xsl:for-each select="(svRepeat[. != ''])[1]">
							<srv:repeatability xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
								<gco:Boolean>
									<xsl:call-template name="boolean"/>
								</gco:Boolean>
							</srv:repeatability>
			...
			<xsl:otherwise>
				<srv:repeatability gco:nilReason="missing" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"/>
			</xsl:otherwise>
		</xsl:choose>
		<xsl:choose>
				...
				<xsl:choose>
					...
					<xsl:when test="count (svValType/aName[. != '']) &gt; 1">
						<xsl:for-each select="(svValType/aName[. != ''])[1]">
							<srv:valueType xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
								<gco:TypeName>
									<gco:aName>
										<gco:CharacterString>
											<xsl:value-of select="."/>
			...
			<xsl:otherwise>
				<srv:valueType gco:nilReason="missing" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"/>
			</xsl:otherwise>
		</xsl:choose>
	</xsl:template>
	...
	<xsl:template name="MemberName">
		<xsl:choose>
				...
				<xsl:choose>
					...
					<xsl:when test="count (aName[. != '']) &gt; 1">
						<xsl:for-each select="(aName[. != ''])[1]">
							<gco:aName xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
								<gco:CharacterString>
									<xsl:value-of select="."/>
								</gco:CharacterString>
							</gco:aName>
			...
			<xsl:otherwise>
				<gco:aName gco:nilReason="missing" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"/>
			</xsl:otherwise>
		</xsl:choose>
		<xsl:choose>
				...
				<xsl:choose>
					...
					<xsl:when test="count (attributeType/aName[. != '']) &gt; 1">
						<xsl:for-each select="(attributeType/aName[. != ''])[1]">
							<gco:attributeType xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
								<gco:TypeName>
									<gco:aName>
										<gco:CharacterString>
											<xsl:value-of select="."/>
			...
			<xsl:otherwise>
				<gco:attributeType gco:nilReason="missing" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"/>
			</xsl:otherwise>
		</xsl:choose>
	</xsl:template>
	...
	<xsl:template name="EX_Extent">	
		...
		<!--ANZLIC: validate Bounding box-->		
		<xsl:for-each select="geoEle/GeoBndBox[*]">
			<xsl:if test="(count(westBL) + count(eastBL) + count(southBL) + count(northBL)) != 4">
				<xsl:message terminate="yes">Validation Fail: Resource.Extents - Bounding box - west, east, south and north are required</xsl:message>
			</xsl:if>
			<xsl:if test="(westBL ='' or (eastBL ='') or (southBL ='') or (northBL =''))">
				<xsl:message terminate="yes">Validation Fail: Resource.Extents - Bounding box - west, east, south and north are required</xsl:message>
			</xsl:if>	
		</xsl:for-each>				
		<!--End: ANZLIC: validate Bounding box-->
	...
	<xsl:template name="EX_GeographicDescription">
		<!--ANZLIC: validate Geographic location-->
		<xsl:if test="(not(geoId/identCode) or geoId/identCode='')">
			<xsl:message terminate="yes">Validation Fail: Geographic Identfier required</xsl:message>
		</xsl:if>	
		<!--End: ANZLIC: validate Geographic location-->
	...
	<xsl:template name="GML_TimePrimitive">
		<xsl:if test="tmPosition[(. != '') or (@date != '')]">
			<gml:TimeInstant xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
				<xsl:call-template name="GML_StandardProperties"/>
		...
		<xsl:if test="tmBegin[(. != '') or (@date != '')] or tmEnd[(. != '') or (@date != '')]">
			<gml:TimePeriod xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
				<xsl:call-template name="GML_StandardProperties"/>
	...
	<xsl:template name="GML_StandardProperties">
		...
		<xsl:for-each select="(gmlDesc[. != ''])[1]">
			<gml:description xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
				<xsl:value-of select="."/>
			</gml:description>
		</xsl:for-each>
		<xsl:for-each select="(gmlDescRef[(. != '') or (@href != '')])[1]">
			<gml:descriptionReference xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
				<xsl:choose>
					<xsl:when test="(@href != '')">
		...
		<xsl:for-each select="(gmlName[. != ''])[1]">
			<gml:name xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
				<xsl:for-each select="(@codeSpace[. != ''])[1]">
					<xsl:attribute name="codeSpace"><xsl:value-of select="."/></xsl:attribute>
				</xsl:for-each>
				<xsl:value-of select="."/>
	...
	<xsl:template name="UnitDefinition">
		...
		<xsl:for-each select="(gmlRemarks[. != ''])[1]">
			<gml:remarks xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
				<xsl:value-of select="."/>
			</gml:remarks>
		</xsl:for-each>
		...
		<xsl:for-each select="(unitSymbol[. != ''])[1]">
			<gml:catalogSymbol xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
				<xsl:choose>
	...
	<xsl:template name="CI_Citation">
		...
		<!-- ANZLIC Validation Citation Title-->
		<xsl:if test="(resTitle = '' or not(resTitle))">
			<xsl:message terminate="yes">Validation Fail: Overview.Citation - Citation Title is required'</xsl:message>
		</xsl:if>
		<!-- End: ANZLIC Validation Citation Title-->
		
		<!-- ANZLIC Validation Resource Reference Date-->
		<!-- The Create date was used-->
		<xsl:if test="/metadata/dataIdInfo/idCitation/date/createDate = '' or not(/metadata/dataIdInfo/idCitation/date/createDate)">
			<xsl:message terminate="yes">Validation Fail: Overview.Citation - Citation Create Date is required'</xsl:message>
		</xsl:if>	
		<!--End: ANZLIC Validation Resource Reference Date-->
		...
		<xsl:for-each select="(resEdDate[. != ''])[1]">
			<xsl:call-template name="dateOrDateTimeElements">
				<xsl:with-param name="eleName" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">gmd:editionDate</xsl:with-param>
			</xsl:call-template>
		</xsl:for-each>
